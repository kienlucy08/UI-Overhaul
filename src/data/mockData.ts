...
export const mockDashboardSurveys = [
  ...
  { id: 'survey_flight', name: 'Structure Flight',    siteId: 'TX6100',  siteName: 'Orange - Claybar',    created: 'Mar 5, 2025 12:19 PM',  status: 'In Progress', type: 'Structure Flight' as SurveyType },
...
// ─── Structure Summary ───────────────────────────────────────────────────────
export const mockStructureSummary = {
  id: 'str_001',
  siteId: 'TX6100',
  siteName: 'Orange - Claybar',
  name: 'Guyed',
  type: 'Guyed',
  owner: 'CTI',
  fccAsrNumber: '1007167',
  ownerStructureId: '10656',
  constructedHeight: '300',
  apexHeight: '308',
  legCount: '3',
  sectionCount: null as string | null,
  legAAzimuth: null as string | null,
  taperCount: null as string | null,
  guyLevelCount: '4',
  guyCompoundsCount: '3',
  elevation: '0',
  baseFaceWidth: '3',
  ...
  manufacturerJobNum: null as string | null,
  coordinates: '32.30459174, -107.752283211',
  highestAppurtenanceName: 'rod',
  highestAppurtenanceDescription: null as string | null,
  safetyClimbPresent: 'Yes',
  topFlashHeadPresent: 'Yes',
  lightingPresent: 'Yes',
  createdAt: 'Oct 8, 2025 12:02 PM',
  editedAt: 'Dec 10, 2025 4:08 PM',
  photos: {
    manufacturerPlate: null as string | null,
    coaxMap: null as string | null,
    horizonNorth: 'horizon_north.jpg',
    horizonEast: 'horizon_east.jpg',
    horizonSouth: 'horizon_south.jpg',
    horizonWest: 'horizon_west.jpg',
    distanceFromTop: 'distance_top.jpg',
    topFlashHead: 'top_flash_head.jpg',
    legAProfile: null as string | null,
    legBProfile: null as string | null,
    legCProfile: null as string | null,
    legDProfile: null as string | null,
    monopoleInterior: null as string | null,
    mountFromGround: null as string | null,
  },
  appurtenances: [
    { id: 'app_001', name: 'Guyed Appurtenance Group', created: 'Oct 8, 2025 12:03 PM' },
  ],
  guyAttachments: [
    { id: 'ga_001', name: '4', created: 'Oct 8, 2025 12:03 PM' },
    { id: 'ga_002', name: '3', created: 'Oct 8, 2025 12:03 PM' },
    { id: 'ga_003', name: '2', created: 'Oct 8, 2025 12:03 PM' },
    { id: 'ga_004', name: '1', created: 'Oct 8, 2025 12:03 PM' },
  ],
  guyAnchorCompounds: [
    { id: 'gac_001', name: 'c', created: 'Oct 8, 2025 12:05 PM' },
    { id: 'gac_002', name: 'b', created: 'Oct 8, 2025 12:05 PM' },
    { id: 'gac_003', name: 'a', created: 'Oct 8, 2025 12:05 PM' },
    { id: 'gac_004', name: 'c', created: 'Feb 12, 2025 10:47 AM' },
    { id: 'gac_005', name: 'b', created: 'Feb 12, 2025 10:46 AM' },
    { id: 'gac_006', name: 'a', created: 'Feb 12, 2025 10:46 AM' },
  ],
  plumbTwistGroups: [
    { id: 'pt_001', name: '3 Leg Guyed', created: 'Dec 10, 2025 9:08 AM' },
    { id: 'pt_002', name: '3 Leg Guyed', created: 'Oct 8, 2025 12:06 PM' },
  ],
  taperChanges: [] as { id: string; name: string; created: string }[],
  structureBases: [
    { id: 'sb_001', name: 'Guyed Base', created: 'Oct 8, 2025 12:03 PM' },
  ],
  sections: [] as { id: string; name: string; created: string }[],
  ports: [] as { id: string; name: string; created: string }[],
}

// ─── Compound Summary ────────────────────────────────────────────────────────
export const mockCompoundSummary = {
  id: 'cmp_001',
  siteId: 'TX6100',
  siteName: 'Orange - Claybar',
  name: 'Compound',
  ...
  availableArea: null as string | null,
  generatorPresent: null as string | null,
  fuelTankPresent: null as string | null,
  fenceType: null as string | null,
  fenceHeight: null as string | null,
  compoundGatePresent: null as string | null,
  powerProvider: 'PNM!!',
  fiberProvider: null as string | null,
  lightningProvider: null as string | null,
  compoundCorner1: 'n,e',
  compoundCorner2: 'n,w',
  elevation: '0',
  createdAt: 'Oct 8, 2025 12:02 PM',
  editedAt: 'Dec 10, 2025 4:08 PM',
  photos: {
    planView: null as string | null,
    cornerPhoto1: 'compound_corner1.jpg',
    cornerPhoto2: 'compound_corner2.jpg',
  },
  bphocs: [
    { id: 'bphoc_001', name: 'Unknown', created: 'Oct 8, 2025 12:02 PM' },
  ],
  compoundGenerals: [
    { id: 'cg_001', name: 'Compound General Group', created: 'Oct 8, 2025 12:02 PM' },
  ],
  compoundAccess: [
    { id: 'ca_001', name: 'Compound Access', created: 'Oct 8, 2025 12:02 PM' },
  ],
}
